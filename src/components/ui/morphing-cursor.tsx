...
export function MagneticText({
  ...
  return (
    ...
    >
      <span className={cn("text-5xl font-bold tracking-tighter text-foreground tracking-wide", textClassName)}>{text}</span>

      <div
        ref={circleRef}
        className={cn("absolute top-0 left-0 pointer-events-none rounded-full overflow-hidden", circleClassName)}
        style={{
      ...
      >
        ...
        >
          <span className={cn("text-5xl font-bold tracking-tighter text-background whitespace-nowrap tracking-wide", circleTextClassName)}>
            {hoverText}
          </span>
        </div>
      </div>
